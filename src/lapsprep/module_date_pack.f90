...
!  this module is able to perform many  date and time functions:
...
! 4.  mm5_to_wrf_date (mm5_date, wrf_date, wrf_time)
!  convert mm5 ascii-format date/time info into wrf date and time
!  wrf date = integer(year*1000+day_of_year)
!  wrf time = real(elapsed seconds since 00utc)

! 5.  wrf_to_mm5_date (wrf_date, wrf_time, mm5_date)
!  inverse of 4.
