...
c
c     yuanfu xie: 2013
c                 change timer_lbfgs call to timer_lbfgs_lbfgs to avoid confusion with intel's
c                 change fortran formatting from d7 to d8
c                 change all double precision to real for saving memory
c
...
c     ************
c-jlm-jn 
c     yuanfu changes these integers to integer*8 for super large
c     minimization:
     ...
     +            lwy,lsy,lss,lwt,lwn,lsnd
      ...
      if (task .eq. 'start') then
         ...
         i8save(3)  = 4*m**2
         i8save(4)  = 1                        ! ws      m*n
         i8save(5)  = i8save(4)  + i8save(1)   ! wy      m*n
         i8save(6)  = i8save(5)  + i8save(1)   ! wsy     m**2
         i8save(7)  = i8save(6)  + i8save(2)   ! wss     m**2
         i8save(8)  = i8save(7)  + i8save(2)   ! wt      m**2
         i8save(9)  = i8save(8)  + i8save(2)   ! wn      4*m**2
         i8save(10) = i8save(9)  + i8save(3)   ! wsnd    4*m**2
         i8save(11) = i8save(10) + i8save(3)   ! wz      n
         i8save(12) = i8save(11) + n           ! wr      n
         i8save(13) = i8save(12) + n           ! wd      n
         i8save(14) = i8save(13) + n           ! wt      n
         i8save(15) = i8save(14) + n           ! wxp     n
         i8save(16) = i8save(15) + n           ! wa      8*m
      endif
      lws  = i8save(4)
      lwy  = i8save(5)
      lsy  = i8save(6)
...
c                     [l_a +r_z  s'aa's   ]
c            
c     z(n),r(n),d(n),t(n), xp(n),wa(8*m) are real working arrays.
...
c
c       minpack2 library ... timer_lbfgs
c
