      subroutine pk_mercator(kfildo,ipack,nd5,is3,ns3,ipkopt,l3264b,
     1                       locn,ipos,ier,*)
c
...
c
c        purpose
c            packs template 3.10, a mercator map projection template,
c            in section 3 of a grib2 message.  it is the responsibility
c            of the calling routine to pack the first 13 octets in 
c            section 3.
c
c        data set use
...
c                       information (in elements 15 through 69)
...
c        a mercator projection.  check for ns3 ge 13
c        assures a value for is3(13).
c
      if(ns3.ge.13)then
c
         if(is3(13).ne.10)then
c           write(kfildo,10)is3(13)
c10         format(/' map projection code ',i4,' indicated by is3(13)'/
c    1              ' is not mercator. please refer to the'/
c    2              ' grib2 documentation to determine the'/
...
c
c        pack the number points along a parallel and the number
c        of points along along a meridian (ni & nj).
...
c
c        pack the latitude at which the mercator projection
c        intersects the earth (the latitude where the latitudinal
c        and longitudinal grid lengths are specified).
      isign=0
...
cwdt     is3(60)=ior(is3(60),16)
cwdt  else
         is3(60)=iand(is3(60),239)
cwdt  endif
c
      call pkbg(kfildo,ipack,nd5,locn,ipos,is3(60),8,n,ier,*900)
c
c        pack the orientation angle of the grid (the angle
c        between the map's i direction and the earth's
c        equator).
      call pkbg(kfildo,ipack,nd5,locn,ipos,is3(61),32,n,ier,*900)
c
c        pack the longitudinal and latitudinal direction grid lengths
      call pkbg(kfildo,ipack,nd5,locn,ipos,is3(65),32,n,ier,*900)
