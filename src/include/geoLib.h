...
void do_grhi_remap(float *ingrid, /* input grid */
                   float *outgrid,  /* output grid */
                   float *flagval,  /* "missing" value */
                   int *save);/*if true non-flagged points in outgrid saved*/

/* Same as do_grhi_remap but with shorts. */
void do_grhi_remap_w(short *ingrid, /* input grid */
                     short *outgrid,  /* output grid */
                     short *flagval,  /* "missing" value */
                     int *save);/*if true non-flagged points in outgrid saved*/
